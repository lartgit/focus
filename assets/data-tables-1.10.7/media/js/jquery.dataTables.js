...
*r2 Comentarios
*
*Modificamos los valores por defecto (en ingles) a español
*tener en cuenta en caso de Multilenguaje.
*
*@Author ARamirez r2Software.
*/
...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sSearch": '<span class="glyphicon glyphicon-search find-button-icon"></span> Buscar:',
