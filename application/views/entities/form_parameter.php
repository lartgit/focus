         ...
         <div class="panel panel-default">
            <div class="panel-body">
               <form role="form" action="<?= $url_action ?>" method="post" class="form-horizontal">
                  <?php if(isset($map_id)):?><input type="hidden" name="map_id" value="<?=$map_id?>"><?php endif; ?>
                  <?php if(isset($region_id)):?><input type="hidden" name="region_id" value="<?=$region_id?>"><?php endif; ?>
                  <?= $form_content ?>
                  <br>
                  <?php if (isset($show)): ?>
