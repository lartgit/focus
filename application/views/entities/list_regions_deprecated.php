        ...
        <div class="col-md-6">
            ...
            <?php if ($user_can_add): ?>
                <a class="btn btn-default btn-sm" href="<?= $url_new ?>">
                    <span class="glyphicon glyphicon-plus"></span> <?= lang('Agregar un Nuevo Proceso') ?>
                </a>
            <?php endif; ?>
            <a class="btn btn-default btn-sm" href="<?= $url_process_list ?>">
                <span class="glyphicon glyphicon-list"></span> <?= lang('Ver Procesos') ?>
            </a>
