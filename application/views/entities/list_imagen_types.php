    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="alert alert-info">
                <strong>Info:</strong> <?= lang('descripcion_de_pantalla_tipo_de_imagen') ?>
            </div>
        </div>
    </div>
   <div class="row">
            ...
            <tbody>
               <?php foreach ($instances as $instance): ?>
                  <tr>
                     ...
                     <td style="text-align: center;"><a href="<?= $url_layer_types . '?image_id=' . $instance->id ?>">
                     	<?= $instance->qt_layers ?>
                     	</a>
                     </td>
                     <?php if ($user_can_edit): ?>
